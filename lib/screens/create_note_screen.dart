                      ...
                      : ElevatedButton(
                          onPressed: () async {
                            if (_formKey.currentState!.validate()) {
                              ...
                              try {
                                await noteService.createNote(title: _titleController.text.trim(), content: _contentController.text.trim(), pinned: _pinned);
                                if (context.mounted) {
                                  ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Not oluşturuldu')));
